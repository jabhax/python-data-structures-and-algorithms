...
def main():
    ...
    print(f'Adjacency List 1: {json.dumps(adjacency_list_graph_1, indent=4)}\n')
    print(f'Adjacency List 2: {json.dumps(adjacency_list_graph_2, indent=4)}\n')
    print(f'Adjacent Matrix: {json.dumps(adjacent_matrix, indent=4)}\n')
