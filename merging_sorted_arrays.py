...
def main():
    ...
    start = time.time()
    print(f'Merged output 1 (Duplicates): '
          f'{merge_sorted_arrays(sorted_1, sorted_2)}')
    print(f'Merged output 2 (No Duplicates): '
          f'{merge_sorted_arrays(sorted_1, sorted_2, duplicates=False)}')
